  function figH1 = plot_fit_probSTFT_kern_cts(pg,mVar,om,lamx,mVarHist,omHist, ...
...
%   spec = get_pSTFT_spec(freqs,lamx,varx,om);
  ...
  hplot1 = plot(linspace(0,1/2,length(pg)),pg,'-k','linewidth',2,'DisplayName','noisy');

  
  ylim([50e-8, 10e+2])
  uistack(hplot1,'bottom');
  set(gca,'yscale','log')
  drawnow;
