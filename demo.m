...
%% hyperparameter learning in the frequency domain based on Wilkinson code but by adding a noise-variance estimate by Fradi
opts = option_list(); % by Wilkinson: gives the option list needed for the function "fit_SM_GP_hyperparameter_spectral_domain"
vary_init = 0.02; % noise variance initialization 
[VarFit,LamFit,omFit,varyFit,Info] = fit_SM_GP_hyperparameter_spectral_domain(ynoisy,D,kernel,fs,vary_init,opts); % find the optimal hyperparameter minimizing  
